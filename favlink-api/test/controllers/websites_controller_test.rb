...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { link: @website.link, list_id: @website.list_id, title: @website.title } }, as: :json
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { link: @website.link, list_id: @website.list_id, title: @website.title } }, as: :json
    assert_response 200
  end
